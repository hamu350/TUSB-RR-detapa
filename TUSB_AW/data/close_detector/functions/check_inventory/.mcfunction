...
data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].close_detector.skip set value 1
function close_detector:check_inventory/loop
execute store result storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].close_detector.skip int 0.9999999999 run data get storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].close_detector.skip
