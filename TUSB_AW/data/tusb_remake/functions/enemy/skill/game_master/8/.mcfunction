...
# title
    ...
    title @a[distance=..60,tag=GameMasterBattle] title {"translate": "§l§4８８８"}
# 武器変更
...
# ノクバ耐性削除
    execute as @a[distance=..60,tag=GameMasterBattle] run attribute @s minecraft:generic.knockback_resistance modifier add 3-1-4-6-2 "GM8" -1 multiply
