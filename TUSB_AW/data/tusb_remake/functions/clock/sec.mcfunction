...
## トカルトの処理
execute unless data storage tusb_remake: settings{toculting:1b} as @a[predicate=tusb_remake:area/tocult_colde,gamemode=!spectator] at @s run function tusb_remake:tocult_process/
execute unless data storage tusb_remake: settings{toculting:1b} as @a[predicate=!tusb_remake:area/tocult_colde,gamemode=!spectator] at @s if entity @e[tag=TocultArea,distance=..32] run function tusb_remake:tocult_process/
execute if data storage tusb_remake: settings{toculting:1b} as @a[predicate=!tusb_remake:area/table_mountain,predicate=!tusb_remake:area/nether_trial,gamemode=!spectator] at @s run function tusb_remake:tocult_process/
