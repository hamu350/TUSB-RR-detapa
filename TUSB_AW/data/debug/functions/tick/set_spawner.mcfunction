...
execute if data storage debug:set_spawner {_:{merge:true}} run data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].set_spawner set from storage debug:set_spawner _.data
