...
テンプレ：/data modify storage debug:set_spawner {} set value {DebugId:,merge:false,set:true,data:{SpawnMob:[{AssetId:,weight:1}],Delay:{Delay:1,Min:100,Max:700},Count:1,Range:4,ReqRange:32,Display:""}}
