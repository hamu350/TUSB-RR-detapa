...
execute if score @s ShowSkill matches 4240 run data modify storage tusb_remake: skill_name set value "§b天気雨"
execute if score @s ShowSkill matches 4250 run data modify storage tusb_remake: skill_name set value "§dホーリーシャワー"
execute if score @s ShowSkill matches 4260 run data modify storage tusb_remake: skill_name set value "§dセイクリットオーラ"