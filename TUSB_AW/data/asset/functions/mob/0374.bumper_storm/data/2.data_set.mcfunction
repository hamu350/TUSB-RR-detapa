...
data modify storage asset: mob set value {Passengers: [{Lifetime: 1800, CustomName: '{"text":"バンパーストーム"}', Passengers: [{Particle: "explosion", Radius: 0.001f, CustomName: '{"text":"バンパーストームの衝撃波"}', Passengers: [{Particle: "minecraft:block air", Radius: 1.55f, ReapplicationDelay: 10, Duration: 999, id: "minecraft:area_effect_cloud", Effects: [{ShowParticles: 1b, Duration: 4, Id: 25b, Amplifier: 60b}, {ShowParticles: 1b, Duration: 40, Id: 8b, Amplifier: 20b}]}], Duration: 999, id: "minecraft:area_effect_cloud", Effects: []}], Health: 100.0f, ArmorItems: [{}, {}, {}, {}], Attributes: [{Base: 100.0d, Name: "generic.max_health"}, {Base: 48.0d, Name: "generic.follow_range"}, {Base: 1.0d, Name: "generic.knockback_resistance"}, {Base: 0.65d, Name: "generic.movement_speed"}, {Base: 0.05d, Name: "generic.attack_damage"}], Silent: 1b, id: "minecraft:endermite", ActiveEffects: [{ShowParticles: 0b, Duration: 700, Id: 14b, Amplifier: 0b}, {ShowParticles: 1b, Duration: 700, Id: 25b, Amplifier: -10b}], HandItems: [{Count: 65b, id: "minecraft:wooden_sword", tag: {RepairCost: 1000000000, Enchantments: [{lvl: 5s, id: "minecraft:knockback"}], Damage: 0}}, {}]}], DeathTime: 19s, Health: 0.0f, Xp: 0, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"}, id: "minecraft:villager", ActiveEffects: [{ShowParticles: 0b, Duration: 20, Id: 14b, Amplifier: 0b}]}
