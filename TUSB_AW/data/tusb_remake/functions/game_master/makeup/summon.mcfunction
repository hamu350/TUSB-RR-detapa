...
title @a[distance=..20] title {"text":"§3§k|||§r§0game §3master§0§k|||§r"}
title @a[distance=..20] subtitle {"text":"§3- §0§k|||§r§o§0終わりなき遊戯§0§k|||§r§3 -","bold":true}
...
function tusb_remake:game_master/spawn