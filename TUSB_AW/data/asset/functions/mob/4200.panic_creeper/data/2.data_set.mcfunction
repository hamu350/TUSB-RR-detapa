...
data modify storage asset: mob set value {Passengers: [{Fuse: 1s, powered: 1b, CustomName: '{"text":"パニッククリーパー"}', Health: 20.0f, Attributes: [{Base: 20.0d, Name: "generic.max_health"}, {Base: 0d, Name: "generic.knockback_resistance"}, {Base: 1.0d, Name: "generic.movement_speed"}], id: "minecraft:creeper", ExplosionRadius: 1.0d, ActiveEffects: [{ShowParticles: 0b, Duration: 2000000000, Id: 8b, Amplifier: 1b}], CustomNameVisible: 1b}], Health: 0.0f, DeathTime: 19s, Xp: 0, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"}, id: "minecraft:villager"}
