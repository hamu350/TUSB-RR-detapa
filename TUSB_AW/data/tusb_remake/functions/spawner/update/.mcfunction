...
execute if score @s SpawnerId matches -1 unless data storage asset:context spawner.SpawnPotentials[0].id run function tusb_remake:spawner/update/multi/
execute if score @s SpawnerId matches 1.. unless data storage asset:context spawner.SpawnPotentials[0].id run function tusb_remake:spawner/update/single/
