...
# 敵、アイテム削除
    execute if entity @s[tag=GameMasterArea] unless data storage tusb_remake: game_master{battle:1b} at @e[type=armor_stand,tag=Boss_MarkerC] @s run tag @e[tag=Enemy,distance=..60] add Garbage
