...
execute as @a if score @s CoolTickSpan matches -49.. run scoreboard players set @s CoolTickSpan -50
### MP回復量 = MPMax / 50 + 3
...
execute as @a if score @s ExpToLevel matches 350.. run scoreboard players set @s ExpToLevel 350
