...
data modify storage asset: mob set value {NoGravity:1b,CustomName:'{"text":"HomingMissile"}',Passengers:[{NoGravity:1b,CustomName:'{"text":"アルテミスの首飾り"}',Passengers:[{Particle:"dragon_breath",Radius:2.0f,CustomName:'{"text":"アルテミスの首飾り"}',Passengers:[{NoGravity:1b,CustomName:'{"text":"アルテミスの首飾り"}',id:"end_crystal",CustomNameVisible:1b,ShowBottom:0b}],Color:16711680,Duration:100,id:"area_effect_cloud",Effects:[{Duration:20,Id:6b,Amplifier:0b}],Age:50,CustomNameVisible:0b}],Attributes:[{Base:10.0d,Name:"generic.maxHealth"}],Silent:1,PersistenceRequired:1b,id:"creeper",ActiveEffects:[{ShowParticles:0b,Duration:2147483647,Id:14b,Amplifier:0b}],CustomNameVisible:0b}],Value:0,id:"experience_orb",Age:-32768,CustomNameVisible:1b}
