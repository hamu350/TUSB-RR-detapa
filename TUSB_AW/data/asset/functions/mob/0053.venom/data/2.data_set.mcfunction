...
data modify storage asset: mob set value {Passengers: [{Passengers: [{Item: {id: "minecraft:lingering_potion", tag: {CustomPotionEffects: [{ShowParticles: 1b, Duration: 200, Id: 19b, Amplifier: 4b}], Potion: "minecraft:water"}}, Potion: {id: "minecraft:lingering_potion", tag: {CustomPotionEffects: [{ShowParticles: 1b, Duration: 200, Id: 19b, Amplifier: 4b}], Potion: "minecraft:water"}}, id: "minecraft:potion"}], CustomName: '{"text":"ﾍﾟｲﾙｽﾊﾟｲﾀﾞｰ"}', Health: 70.0f, Attributes: [{Base: 70.0d, Name: "generic.max_health"}, {Base: 48.0d, Name: "generic.follow_range"}, {Base: 1.0d, Name: "generic.knockback_resistance"}, {Base: 0.4d, Name: "generic.movement_speed"}, {Base: 1.0d, Name: "generic.attack_damage"}], id: "minecraft:cave_spider"}, {Passengers: [{Particle: "entity_effect", Radius: 1.55f, ReapplicationDelay: 10, CustomName: '{"text":"ｳﾞｪﾉﾑﾐｽﾄ"}', Color: 52312, Duration: 999, id: "minecraft:area_effect_cloud", Effects: [{ShowParticles: 1b, Duration: 200, Id: 19b, Amplifier: 60b}, {ShowParticles: 1b, Duration: 200, Id: 4b, Amplifier: 10b}]}], CustomName: '{"text":"ｳﾞｪﾉﾑ"}', Health: 250.0f, Attributes: [{Base: 250.0d, Name: "generic.max_health"}, {Base: 48.0d, Name: "generic.follow_range"}, {Base: 1.0d, Name: "generic.knockback_resistance"}, {Base: 0.29d, Name: "generic.movement_speed"}, {Base: 0.0d, Name: "generic.attack_damage"}], Silent: 1b, id: "minecraft:endermite", ActiveEffects: [{ShowParticles: 0b, Duration: 2147483647, Id: 14b, Amplifier: 0b}, {ShowParticles: 0b, Duration: 2147483647, Id: 8b, Amplifier: 17b}, {ShowParticles: 0b, Duration: 2147483647, Id: 25b, Amplifier: -2b}]}, {Fuse: 5s, Passengers: [{Particle: "happy_villager", Radius: 0.001f, CustomName: '{"text":"飾"}', Duration: 999, id: "minecraft:area_effect_cloud", Effects: []}, {Item: {id: "minecraft:lingering_potion", tag: {CustomPotionEffects: [{ShowParticles: 1b, Duration: 200, Id: 19b, Amplifier: 4b}], Potion: "minecraft:water"}}, Potion: {id: "minecraft:lingering_potion", tag: {CustomPotionEffects: [{ShowParticles: 1b, Duration: 200, Id: 19b, Amplifier: 4b}], Potion: "minecraft:water"}}, id: "minecraft:potion"}], CustomName: '{"text":"ﾍﾟｲﾙｸﾘｰﾊﾟｰ"}', Health: 100.0f, Attributes: [{Base: 100.0d, Name: "generic.max_health"}, {Base: 48.0d, Name: "generic.follow_range"}, {Base: 1.0d, Name: "generic.knockback_resistance"}, {Base: 0.3d, Name: "generic.movement_speed"}, {Base: 1.0d, Name: "generic.attack_damage"}], Silent: 1b, id: "minecraft:creeper", ExplosionRadius: 0b, ActiveEffects: [{ShowParticles: 1b, Duration: 2147483647, Id: 14b, Amplifier: 0b}, {ShowParticles: 1b, Duration: 1200, Id: 10b, Amplifier: 2b}]}], Health: 0.0f, DeathTime: 19s, Xp: 0, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"}, id: "minecraft:villager", ActiveEffects: [{ShowParticles: 0b, Duration: 20, Id: 14b, Amplifier: 0b}]}
