...
data modify storage asset: mob set value {Profession:0,Passengers:[{UUIDLeast:"neoL",Health:1000.0f,Attributes:[{Base:0.8d,Name:"generic.movement_speed"},{Base:250,Name:"generic.attack_damage"},{Base:99,Name:"generic.follow_range"},{Base:1000,Name:"generic.max_health"}],CustomName:"Спецназ",UUIDMost:"nemoL",Passengers:[{CustomName:"SVDS Dragunov",Elder:0b,Health:500.0f,ArmorItems:[{},{},{},{id:"iron_helmet",Count:0b}],Attributes:[{Base:300,Name:"generic.attack_damage"},{Base:99,Name:"generic.follow_range"},{Base:500,Name:"generic.max_health"},{Base:0.7d,Name:"generic.knockback_resistance"}],Silent:1,PersistenceRequired:1,id:"guardian",Tags:["FloatingRequired"],ActiveEffects:[{ShowParticles:0b,Duration:1200000,Id:12,Amplifier:0},{ShowParticles:0b,Duration:1200000,Id:14,Amplifier:127}]}],ArmorItems:[{id:"iron_boots",Count:0b,tag:{Enchantments:[{lvl:10,id:protection},{lvl:10,id:projectile_protection},{lvl:5,id:depth_strider}]}},{},{},{}],PersistenceRequired:1,id:"spider",Tags:["AbyssWarp","SkillMob","CanFire","PaleRider","akuu"],ActiveEffects:[{Duration:1200000,Id:12,Amplifier:0},{ShowParticles:0b,Duration:1200000,Id:24,Amplifier:0}],CustomNameVisible:1}],DeathTime:19s,Health:0.0f,id:"villager"}
