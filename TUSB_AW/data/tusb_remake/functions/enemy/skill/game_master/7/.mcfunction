...
# title
    ...
    title @a[distance=..60,tag=GameMasterBattle] title ["",{"text":"k","obfuscated":true,"color":"black"},{"text":"7 7 7","color":"yellow"},{"text":"k","obfuscated":true,"color":"black"}]
    title @a[distance=..60,tag=GameMasterBattle] subtitle {"text":"JackPot","color":"yellow"} 
# sound
    playsound minecraft:ui.toast.challenge_complete player @a[distance=..60,tag=GameMasterBattle] ~ ~ ~ 2 1
# tellraw
    tellraw @a[distance=..60,tag=GameMasterBattle] "§l§4逃げろ!!!!"
# summon
