...
data modify storage asset: mob set value {Passengers:[{CustomName:'{"text":"魔氷樹"}',Passengers:[{Passengers:[{Particle:"block lime_terracotta",Radius:4.5f,Duration:999,id:"area_effect_cloud",Effects:[{Duration:200,Id:8,Amplifier:236}]},{Passengers:[{Particle:"block lime_wool",Radius:3.5f,Duration:999,id:"area_effect_cloud",Effects:[{Duration:200,Id:8b,Amplifier:236}]},{Passengers:[{Particle:"block cactus",Radius:2.5f,Duration:999,id:"area_effect_cloud",Effects:[{Duration:200,Id:8b,Amplifier:236}]},{DisplayOffset:-16,RequiredPlayerRange:17s,CustomDisplayTile:1b,MaxNearbyEntities:6,SpawnCount:3,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,Delay:1,SpawnData:{entity:{NoGravity:1b,Passengers:[{CustomName:'{"text":"肉食果実"}',RabbitType:99,Health:50.0f,Attributes:[{Base:0.8d,Name:"generic.movement_speed"},{Base:50.0d,Name:"generic.max_health"},{Base:50.0d,Name:"generic.attack_damage"}],DeathLootTable:"empty",id:"rabbit",Tags:["enemy"],ActiveEffects:[{Duration:3600,Id:20b,Amplifier:0b}]}],Value:-1000,id:"experience_orb",Age:80}},id:"spawner_minecart",MaxSpawnDelay:100s,SpawnRange:8s,MinSpawnDelay:50s},{DisplayOffset:-32,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-48,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-64,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-80,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-96,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-112,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-128,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-144,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-160,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-176,CustomDisplayTile:1,DisplayTile:{"block":{Name:"birch_log"}},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-192,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"}],id:"enderman",ActiveEffects:[{Duration:3600,Id:14b,Amplifier:0b}]}],id:"enderman",ActiveEffects:[{Duration:3600,Id:14b,Amplifier:0b}]}],id:"enderman",ActiveEffects:[{Duration:3600,Id:14b,Amplifier:0b}]}],Health:1000.0f,Attributes:[{Base:1000.0d,Name:"generic.max_health"},{Base:80.0d,Name:"generic.attack_damage"},{Base:1.0d,Name:"generic.knockback_resistance"}],id:"enderman",ActiveEffects:[{Duration:3600,Id:14b,Amplifier:0b}],Tags:["SkillMob","WarpOnly","leap"]}],Health:0.0f,DeathTime:19s,id:"villager",ActiveEffects:[{ShowParticles:0b,Duration:20,Id:14b,Amplifier:0b}]}
