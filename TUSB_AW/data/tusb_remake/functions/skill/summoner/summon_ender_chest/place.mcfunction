...
execute if block ~ ~ ~ ender_chest summon minecraft:item_frame ~ ~ ~ {Fixed:true,Invulnerable:true,Invisible:true,Facing:1b,Tags:[MagicBlock,MagicEnderChest,PreMagicBlock,SystemEntity,TypeChecked]}
