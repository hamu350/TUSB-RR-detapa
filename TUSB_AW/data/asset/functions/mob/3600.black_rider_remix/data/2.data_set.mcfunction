...
data modify storage asset: mob set value {Passengers: [{Variant: 1028, Tame: 1b, Passengers: [{CustomName: '{"text":"§0ブラックライダー§r §6Remix"}', Health: 1000.0f, ArmorItems: [{id: "minecraft:leather_boots", tag: {display: {color: 0}, Damage: 0}, Count: 65b}, {id: "minecraft:leather_leggings", tag: {display: {color: 0}, Damage: 0}, Count: 65b}, {id: "minecraft:leather_chestplate", tag: {display: {color: 0}, Damage: 0}, Count: 65b}, {id: "minecraft:player_head", tag: {SkullOwner: {Id: [I; 383571565, -552185915, -1606886558, 1220983664], Properties: {textures: [{Value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMWQ4NDdjMzdiNTMxZmE5MmJiOTVkNGMwNzBlNWQ4N2IzMjU2YTljNjVhZTUyMWE1OTgxMzMyOTBjN2NiYiJ9fX0="}]}}}, Count: 65b}], Attributes: [{Base: 1000.0d, Name: "generic.max_health"}, {Base: 0.45d, Name: "generic.movement_speed"}, {Base: 4.0d, Name: "generic.attack_damage"}, {Base: 0.35d, Name: "generic.knockback_resistance"}, {Base: 32.0d, Name: "generic.follow_range"}], PersistenceRequired: 1b, DeathLootTable: "usb:events/goddess", id: "minecraft:wither_skeleton", NoAI: 0b, Tags: ["BlackRiderR", "SkillMob"], ActiveEffects: [{ShowParticles: 0b, Duration: 2147483647, Id: 11b, Amplifier: 2b}, {ShowParticles: 0b, Duration: 2147483647, Id: 8b, Amplifier: 3b}], HandItems: [{id: "minecraft:brewing_stand", tag: {Enchantments: []}, Count: 65b}, {}], CustomNameVisible: 1b}], Health: 400.0f, Attributes: [{Base: 400.0d, Name: "generic.max_health"}, {Base: 0.45d, Name: "generic.movement_speed"}, {Base: 0.35d, Name: "generic.knockback_resistance"}, {Base: 5.0d, Name: "horse.jump_strength"}], id: "minecraft:horse", NoAI: 0b, Tags: ["AbyssWarp"], ActiveEffects: [{ShowParticles: 0b, Duration: 2147483647, Id: 11b, Amplifier: 1b}, {ShowParticles: 0b, Duration: 2147483647, Id: 12b, Amplifier: 0b}], Saddle: 1b}], id: "minecraft:experience_orb", Age: 6000s}
