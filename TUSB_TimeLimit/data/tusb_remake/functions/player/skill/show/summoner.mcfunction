...
execute if score @s ShowSkill matches 6090 run data modify storage tusb_remake: skill_name set value "循環術：魔力循環"
...
execute if score @s ShowSkill matches 6310 run data modify storage tusb_remake: skill_name set value "§bテスラフレア"
execute if score @s ShowSkill matches 6320 run data modify storage tusb_remake: skill_name set value "§dファイナルカタストロフィ"
