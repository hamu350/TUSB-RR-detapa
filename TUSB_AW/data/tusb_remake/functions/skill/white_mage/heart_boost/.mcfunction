...
execute if score @s ActivatedSkill matches 4010 run effect give @a[distance=..15] minecraft:health_boost 180 1
execute if score @s ActivatedSkill matches 4011 run effect give @a[distance=..15] minecraft:absorption 180 3
execute if score @s ActivatedSkill matches 4010 run effect give @a[distance=..15] minecraft:health_boost 180 3
execute if score @s ActivatedSkill matches 4012 run effect give @a[distance=..15] minecraft:absorption 180 5
execute if score @s ActivatedSkill matches 4010 run effect give @a[distance=..15] minecraft:health_boost 180 5
execute if score @s ActivatedSkill matches 4013 run effect give @a[distance=..15] minecraft:absorption 180 7
execute if score @s ActivatedSkill matches 4010 run effect give @a[distance=..15] minecraft:health_boost 180 7
execute if score @s ActivatedSkill matches 4014..4019 run effect give @a[distance=..15] minecraft:absorption 180 9
execute if score @s ActivatedSkill matches 4010 run effect give @a[distance=..15] minecraft:health_boost 180 9
