...
data modify storage asset: mob set value {Passengers: [{Variant: 0, ArmorItem: {id: "iron_horse_armor", Count: 65b, Damage: 0s}, Tame: 1b, Passengers: [{CustomName: '{"text":"§2ペイルライダー§r §6Remix"}', Health: 1000.0f, ArmorItems: [{id: "minecraft:leather_boots", tag: {display: {color: 4814131}, Damage: 0}, Count: 65b}, {id: "minecraft:leather_leggings", tag: {display: {color: 4814131}, Damage: 0}, Count: 65b}, {id: "minecraft:leather_chestplate", tag: {display: {color: 4814131}, Damage: 0}, Count: 65b}, {id: "minecraft:player_head", tag: {SkullOwner: {Id: [I; -934393862, 1150435969, -1422980269, -245461163], Properties: {textures: [{Value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMjJlNzljYmNlMTdiZmY4YTdiMjQ4NjRmYmMzZDNkOTc3ZWVhNTQ0YmRjMmJiODY3ODU4YjM1ZDUwMWI0NTY3In19fQ=="}]}}}, Count: 65b}], Attributes: [{Base: 1000.0d, Name: "generic.max_health"}, {Base: 0.45d, Name: "generic.movement_speed"}, {Base: 10.0d, Name: "generic.attack_damage"}, {Base: 0.35d, Name: "generic.knockback_resistance"}, {Base: 32.0d, Name: "generic.follow_range"}], PersistenceRequired: 1b, DeathLootTable: "usb:events/goddess", id: "minecraft:zombie", NoAI: 0b, Tags: ["PaleRiderR", "SkillMob"], ActiveEffects: [{ShowParticles: 0b, Duration: 2147483647, Id: 11b, Amplifier: 2b}, {ShowParticles: 0b, Duration: 2147483647, Id: 8b, Amplifier: 3b}], HandItems: [{id: "minecraft:diamond_hoe", tag: {Enchantments: [], Damage: 0}, Count: 65b}, {}], CustomNameVisible: 1b}], Health: 400.0f, Attributes: [{Base: 400.0d, Name: "generic.max_health"}, {Base: 0.45d, Name: "generic.movement_speed"}, {Base: 0.35d, Name: "generic.knockback_resistance"}, {Base: 5.0d, Name: "horse.jump_strength"}], id: "minecraft:zombie_horse", NoAI: 0b, Tags: ["AbyssWarp"], ActiveEffects: [{ShowParticles: 0b, Duration: 2147483647, Id: 11b, Amplifier: 1b}], Saddle: 1b}], id: "minecraft:experience_orb", Age: 6000s}
