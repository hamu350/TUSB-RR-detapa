...
execute if data storage debug:set_block_spawner {_:{merge:true}} run data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].set_block_spawner merge from storage debug:set_block_spawner _.data
execute if data storage debug:set_block_spawner {_:{merge:false}} run data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].set_block_spawner set from storage debug:set_block_spawner _.data
