...
execute if score _ TUSB matches ..9 run tag @s[scores={AreaChangeFlag=11}] add NotCaptureIsland
execute if score _ TUSB matches ..9 run tellraw @s[scores={AreaChangeFlag=11},tag=NotCaptureIsland] {"text": "１０島の攻略が必要です！"}
