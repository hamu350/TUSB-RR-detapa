...
execute as @s[scores={CurrentMode=2250..2259}] run function tusb_remake:skill/ninja/taiso/spell
...
execute as @s[scores={CurrentMode=5260..5269}] run function tusb_remake:skill/black_mage/mazikaru/spell
execute as @s[scores={CurrentMode=5270..5279}] run function tusb_remake:skill/black_mage/syawa_/spell
