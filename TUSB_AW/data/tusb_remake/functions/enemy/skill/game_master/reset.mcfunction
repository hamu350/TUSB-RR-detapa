...
execute as @e[tag=GM7] at @s run particle minecraft:explosion ~ ~ ~ 3 3 3 0.1 200 force
data modify storage score_damage: Argument set value {Damage:800.00,DamageType:"Projectile"}
execute at @e[tag=GM7] as @a[distance=..6] run function score_damage:api/attack
