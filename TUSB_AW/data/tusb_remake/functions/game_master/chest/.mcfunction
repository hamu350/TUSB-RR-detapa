...
#チェストにぶちこみ
data modify block -2712 74 -378 Items set from storage tusb_remake: game_master.chast.Items

data modify block -2712 74 -379 Items set from storage tusb_remake: game_master.chastB.Items
