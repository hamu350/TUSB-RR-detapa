#> asset:villager/0044.happiness_c/trade_info/2.trade_info
...
data modify storage asset: villager.Offers.Recipes set value [{maxUses: 1, buyB: {id: "minecraft:air", Count: 0b}, buy: {id: "minecraft:emerald_block", Count: 12b}, sell: {id: "minecraft:armor_stand", Count: 4b, tag: {NoGravity: 1b, RepairCost: 1000000000, display: {Lore: ['{"text":"§2半径15m以内のすべてに"}', '{"text":"§2等しく§7死§2を与える。"}'], Name: '{"text":"§c全滅の印板"}'}, Enchantments: [], EntityTag: {Tags: ["SignStand", "WidowMaker", "TypeChecked"], id: "minecraft:armor_stand"}, Invulnerable: 1b, Invisible: 1b}}, xp: 1, uses: 0, priceMultiplier: 0.0f, specialPrice: 0, demand: 0, rewardExp: 0b}]
