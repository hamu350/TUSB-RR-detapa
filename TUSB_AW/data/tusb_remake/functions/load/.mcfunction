...
### Const 今回は使いたくない！！
data modify storage tusb_remake: Const.ExpMul set value 9
...
### アップデートを確認
# デバッグモードなら実行しない
execute if score Debug Settings matches 0 unless data storage tusb_remake: {settings:{version:"1.0.3"}} run function tusb_remake:load/update/