...
data modify storage asset: mob set value {Brain: {memories: {}}, HurtByTimestamp: 0, IsBaby: 0b, Attributes: [{Base: 60.0d, Name: "minecraft:generic.follow_range"}, {Base: 1020.0d, Name: "minecraft:generic.max_health"}, {Base: 0.0d, Name: "minecraft:generic.armor_toughness"}, {Base: 444.0d, Name: "minecraft:generic.attack_damage"}, {Base: 0.05d, Name: "minecraft:generic.movement_speed"}, {Base: 1.0d, Name: "minecraft:generic.knockback_resistance"}, {Base: 2.0d, Name: "minecraft:generic.armor"}], Invulnerable: 0b, FallFlying: 0b, PortalCooldown: 0, AbsorptionAmount: 0.0f, InWaterTime: -1, FallDistance: 0.0f, DeathTime: 0s, HandDropChances: [0.085f, 0.085f], PersistenceRequired: 0b, UUID: [I; -841868847, 1618497342, -1593365209, -1006326833], Tags: ["AbyssWarp", "TypeChecked", "Poofable", "akuu", "Enemy"], Motion: [0.0011289240975853904d, -0.0784000015258789d, 7.176157115035184E-4d], Health: 1020.0f, LeftHanded: 0b, Air: 300s, OnGround: 1b, Rotation: [302.44263f, 0.0f], HandItems: [{id: "minecraft:diamond_pickaxe", Count: 65b, tag: {Damage: 0, display: {Name: '"全能ノ一"'}, Enchantments: [{lvl: 5s, id: "sharpness"}, {lvl: 5s, id: "knockback"}, {lvl: 5s, id: "fire_aspect"}, {lvl: 5s, id: "efficiency"}, {lvl: 5s, id: "unbreaking"}, {lvl: 5s, id: "fortune"}]}}, {}], ArmorDropChances: [0.085f, 0.085f, 0.085f, 0.085f], CustomName: '{"bold":true,"color":"dark_purple","text":"古の深淵様"}', Pos: [-2734.5455756907636d, 89.0d, -380.16463778963515d], CanBreakDoors: 0b, Fire: -1s, ArmorItems: [{id: "minecraft:leather_boots", Count: 65b, tag: {Damage: 0, display: {color: 8339378, Name: '"終焉ヲ告ゲル者"'}, Enchantments: [{lvl: 0s, id: "protection"}, {lvl: 1s, id: "fire_protection"}, {lvl: 2s, id: "feather_falling"}, {lvl: 3s, id: "blast_protection"}, {lvl: 4s, id: "projectile_protection"}, {lvl: 5s, id: "respiration"}, {lvl: 6s, id: "aqua_affinity"}, {lvl: 7s, id: "thorns"}, {lvl: 8s, id: "depth_strider"}]}}, {id: "minecraft:leather_leggings", Count: 65b, tag: {Damage: 0, display: {color: 8339378, Name: '"終焉ヲ告ゲル者"'}, Enchantments: [{lvl: 0s, id: "protection"}, {lvl: 1s, id: "fire_protection"}, {lvl: 2s, id: "feather_falling"}, {lvl: 3s, id: "blast_protection"}, {lvl: 4s, id: "projectile_protection"}, {lvl: 5s, id: "respiration"}, {lvl: 6s, id: "aqua_affinity"}, {lvl: 7s, id: "thorns"}, {lvl: 8s, id: "depth_strider"}]}}, {id: "minecraft:leather_chestplate", Count: 65b, tag: {Damage: 0, display: {color: 8339378, Name: '"終焉ヲ告ゲル者"'}, Enchantments: [{lvl: 0s, id: "protection"}, {lvl: 1s, id: "fire_protection"}, {lvl: 2s, id: "feather_falling"}, {lvl: 3s, id: "blast_protection"}, {lvl: 4s, id: "projectile_protection"}, {lvl: 5s, id: "respiration"}, {lvl: 6s, id: "aqua_affinity"}, {lvl: 7s, id: "thorns"}, {lvl: 8s, id: "depth_strider"}]}}, {id: "minecraft:chorus_flower", Count: 65b, tag: {Enchantments: [{lvl: 20s, id: "minecraft:protection"}]}}], CanPickUpLoot: 0b, HurtTime: 0s, ActiveEffects: [{Ambient: 0b, ShowIcon: 0b, ShowParticles: 0b, Duration: 2147483482, Id: 14, Amplifier: 127b}, {Ambient: 0b, ShowIcon: 0b, ShowParticles: 0b, Duration: 2147483482, Id: 8, Amplifier: 4b}, {Ambient: 0b, ShowIcon: 0b, ShowParticles: 0b, Duration: 2147483482, Id: 11, Amplifier: 1b}], DrownedConversionTime: -1}
