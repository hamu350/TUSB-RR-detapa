...
data modify storage tusb_remake: _.28 set value {name:["§dエースインザホール"],level:[100],cost:200,description:[["矢の周囲にいる味方の体力を持続回復し、敵にダメージを与える。着弾時、広範囲の味方の体力を回復し、敵にダメージを与える"]],condition:"利き手で弓を構え矢を放つ",range:[8]}
