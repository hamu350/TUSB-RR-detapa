#> asset:villager/0045.happiness_d/trade_info/2.trade_info
...
data modify storage asset: villager.Offers.Recipes set value [{maxUses: 1, buyB: {id: "minecraft:air", Count: 0b}, buy: {id: "minecraft:emerald_block", Count: 12b}, sell: {id: "minecraft:diamond", Count: 2b, tag: {RepairCost: 1000000000, Legacy: 1b, display: {Name: '{"text":"メリケンサック"}'}, Enchantments: [{lvl: 100s, id: "minecraft:sharpness"}, {lvl: 100s, id: "minecraft:knockback"}, {lvl: 100s, id: "minecraft:fire_aspect"}]}}, xp: 1, uses: 0, priceMultiplier: 0.0f, specialPrice: 0, demand: 0, rewardExp: 0b}]
