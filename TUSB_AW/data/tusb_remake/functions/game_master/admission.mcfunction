...
# 戦闘外なので誰でもウェルカム
execute unless data storage tusb_remake: game_master{battle:1b} if score _ TUSB matches ..20 run tp @p -2774 225 -280

# 関係者なので入場可能
execute if data storage tusb_remake: game_master{battle:1b} if score _ TUSB matches ..20 if entity @p[tag=GameMasterBattle] run tp @p -2774 225 -280