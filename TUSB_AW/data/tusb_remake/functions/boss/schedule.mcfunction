...
execute as @e[type=wither_skeleton,tag=InfinityBoss] at @s unless entity @a[distance=..64,tag=InfinityBossBattle,gamemode=adventure] run function tusb_remake:boss/bosswin/
