...
### 4097?
particle end_rod ~ ~0.5 ~ 30 30 30 1 700 force @a[distance=..64]

### 30 -> 50 -> 75
execute if score @s ActivatedSkill matches 4260..4269 run data modify storage score_damage: Argument set value {Damage:600.00,DamageType:"Projectile"}
