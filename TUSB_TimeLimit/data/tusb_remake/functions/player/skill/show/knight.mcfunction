...
execute if score @s ShowSkill matches 1260 run data modify storage tusb_remake: skill_name set value "§bウォープレリュード"
execute if score @s ShowSkill matches 1270 run data modify storage tusb_remake: skill_name set value "§d夢想真説"
