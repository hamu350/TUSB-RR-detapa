...
data modify storage asset: mob set value {Passengers: [{Variant: 0, ArmorItem: {id: "iron_horse_armor", Count: 65b, Damage: 0s}, Tame: 1b, Passengers: [{CustomName: '{"text":"§fホワイトライダー§r §6Remix"}', Health: 1000.0f, ArmorItems: [{id: "minecraft:chainmail_boots", tag: {Damage: 0}, Count: 65b}, {id: "minecraft:chainmail_leggings", tag: {Damage: 0}, Count: 65b}, {id: "minecraft:chainmail_chestplate", tag: {Damage: 0}, Count: 65b}, {id: "minecraft:player_head", tag: {SkullOwner: {Id: [I; -2072900338, 1700088339, -2071815461, -995547600], Properties: {textures: [{Value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZjhmYzEwZjkzNjRhY2U1MzFhMDJjNmNmZTg5MjcxOWFiMzFiZDQzMjkzZmQ0ZWVkOWNlODdjYzFiNWM3MTIifX19"}]}}}, Count: 65b}], Attributes: [{Base: 1000.0d, Name: "generic.max_health"}, {Base: 0.45d, Name: "generic.movement_speed"}, {Base: 4.0d, Name: "generic.attack_damage"}, {Base: 0.35d, Name: "generic.knockback_resistance"}, {Base: 32.0d, Name: "generic.follow_range"}], PersistenceRequired: 1b, DeathLootTable: "usb:events/goddess", id: "minecraft:skeleton", NoAI: 0b, Tags: ["WhiteRiderR", "SkillMob"], ActiveEffects: [{ShowParticles: 0b, Duration: 2147483647, Id: 11b, Amplifier: 1b}, {ShowParticles: 0b, Duration: 2147483647, Id: 8b, Amplifier: 3b}], HandItems: [{id: "minecraft:bow", tag: {Enchantments: [], Damage: 0}, Count: 65b}, {}], CustomNameVisible: 1b}], Health: 400.0f, Attributes: [{Base: 400.0d, Name: "generic.max_health"}, {Base: 0.45d, Name: "generic.movement_speed"}, {Base: 0.35d, Name: "generic.knockback_resistance"}, {Base: 5.0d, Name: "horse.jump_strength"}], id: "minecraft:skeleton_horse", NoAI: 0b, Tags: ["AbyssWarp"], ActiveEffects: [{ShowParticles: 0b, Duration: 2147483647, Id: 11b, Amplifier: 0b}], Saddle: 1b}], id: "minecraft:experience_orb", Age: 6000s}
